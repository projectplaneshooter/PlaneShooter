 ...
 */
public class TriangleBodyL extends TriangleBody {

    public TriangleBodyL() {
    }

    public TriangleBodyL(Point dpos, ICombatUnit parent) {
        super(dpos, parent);
    }
    ...
    public void paintUnit(Graphics g, Combat combat) {
        ...
        g.drawImage(ResourceHelper.Part_TriangleBodyL_Full,getPos().x-25,getPos().y-25,50,50,null);
        //g.drawPolygon(this.getContour());
    }

    @Override
    public PlanePart getMirroredPart() {
        return new TriangleBodyR();
    }
}
